...
void setup()
{
  ...
  for (int i = 1; i<7; i++)
  {
    if (i<5)
    {
      ...
      playTone(i+500/i);    //Play each tone used
  ...
  lcd.print("Pulsa un Boton");
    ...
    {
     lcd.setCursor(0,1);
     lcd.print("1=modo1 2=modo2 3=mute");
    ...
    {
      lcd.clear();
      lcd.print("Te equivocaste!");
      lcd.setCursor(0,1);
      lcd.print("Puedes mejorar!");
      delay(2000);
      lcd.clear();
      lcd.print("Puntaje: "); 
      lcd.setCursor(0,1);
  ...
  */  
  int getButtonPressed()
  {
    ...
    if (userValue < 600)
    { 
      buttonPressed = 6;      // Maybe Button 4 still to check others
    }
    if (userValue < 700)
    { 
      buttonPressed = 5;      // Maybe Button 4 still to check others
    }
    if (userValue < 800)
    { 
  ...
  */
  ...
  {
      int tones[8] = { 110, 123, 65, 147, 988, 1397, 500, 3000}; 
